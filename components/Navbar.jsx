                        ...
                        !user ? (
                            ...
                            <UserButton>
                                <UserButton.MenuItems>
                                    <UserButton.Action labelIcon={<PackageIcon size={14} />} label="My Orders" onClick={() => router.push('/orders')} />
                                </UserButton.MenuItems>
                            </UserButton>
                        )
                       }
                    ...
                    <div className="sm:hidden">
                        {
                            user ? (
                                <div>
                                      <UserButton>
                                <UserButton.MenuItems>
                                    <UserButton.Action labelIcon={<ShoppingCart size={14} />} label="cart" onClick={() => router.push('/cart')} />
                                </UserButton.MenuItems>
                            </UserButton>
                              <UserButton>
                                <UserButton.MenuItems>
